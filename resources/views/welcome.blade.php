...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex text-center justify-center pt-8 sm:justify-center sm:pt-0">
            ...
            <div class="max-w-screen-lg bg-orange-500 shadow-2xl rounded-lg mx-auto text-center py-12 mt-4">
                <h2 class="text-3xl leading-9 font-bold tracking-tight text-white sm:text-4xl sm:leading-10">
                    Test Technical Software Developert
                </h2>
                <h4 class="text-3xl leading-9 font-bold tracking-tight text-white sm:text-4xl sm:leading-10">
